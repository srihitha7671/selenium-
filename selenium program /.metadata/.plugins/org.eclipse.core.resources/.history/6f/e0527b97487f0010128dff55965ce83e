...
public class sample {
    ...
    public static void main(String[] args) {
        ...
        driver.findElement(By.xpath("//*[@id='input-firstname']")).sendKeys("srihitha");
        driver.findElement(By.xpath("//*[@id='input-lastname']")).sendKeys("pusuluru");
        driver.findElement(By.xpath("//*[@id='input-email']")).sendKeys("srihitha@gmail.com");
